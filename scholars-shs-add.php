<html lang="en" dir="ltr">
    <head>
        <meta charset="UTF-8">
        <!--<title>  </title>-->
        <link rel="stylesheet" type="text/css" href="css/scholars-shs-add.css"/>
    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="wrapper">
                <div class="add">
                    <h1> Add Senior High School Student </h1>
                    <form method="$_POST">
                        ...
                        <table rules="all" style="border-color: #F3F1EF;">
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="text" name="school" placeholder="School" required>
                                    <td>
                                      ...
                                      <td>
                                        <select name="strand" placeholder="- Select -" required>
                                            <option value="Grade 7"> STEM </option>
                                            <option value="Grade 8"> ABM </option>
                                            <option value="Grade 9"> HUMMS </option>
                                            <option value="Grade 10"> GAS </option>
                                        </select>
